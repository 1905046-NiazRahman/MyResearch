...
def plot_results(results):
    results.plot.barh(figsize=(13,5), xlim=(0.4, 1.1))
    plt.axvline(x=0.5, color='k', alpha=1, ls='--')
    plt.axvline(x=0.6, color='k', alpha=1, ls='--')
    plt.axvline(x=0.7, color='k', alpha=1, ls='--')
    plt.axvline(x=0.8, color='k', alpha=1, ls='--')
    plt.axvline(x=0.9, color='k', alpha=1, ls='--')
